...
(function () {
    ...
    THREE.TransformControls = function ( camera, domElement, editor ) {
        ...
        function onPointerMove( event ) {
            ...
            if ( scope.object === undefined || scope.axis === null || _dragging === false ) {
                editor.isCurrentlyTransforming = false;
                return;
            }
        ...
        function onPointerUp( event ) {
            ...
            if(editor.isCurrentlyTransforming) {
                editor.editObject(editor.selected);
            }
